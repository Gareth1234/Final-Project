...
public class Groceries {
  ...
  */
  ...
  System.out.println("The total bill for the Apples is: " + Information.printMoney(apples1.getTotalCost() ) );
  diameter = Information.orangeDiameter;
  Orange oranges1 = new Orange (orangeNumber, diameter); //Creating object with Oranges ordered
  System.out.println(oranges1); //Console Orange Order
  System.out.println("The total bill for the Oranges is: " + Information.printMoney(oranges1.getTotalCost() ) );
  double boxWidth = Information.chocolateBoxWidth;
  double boxLength = Information.chocolateBoxLength;
  double boxHeight = Information.chocolateBoxHeight;
  Chocolate chocolate1 = new Chocolate (chocolateNumber, boxWidth, boxLength, boxHeight); //Creating object with Chocolate ordered
  System.out.println(chocolate1); //Console Choclate Order
  System.out.println("The total bill for the Chocolate is: " + Information.printMoney(chocolate1.getTotalCost() ) );
